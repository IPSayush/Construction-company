...
let links = nav_2.querySelectorAll("a");
links.forEach((link)=>{
...
//
// This is for infinity scroll
// const parent = document.getElementById('more_project_div_2');

// // Duplicate child elements for seamless scroll
// function duplicateChildren() {
//     for (let i = 0; i < 4; i++) {
//         parent.appendChild(parent.children[i].cloneNode(true));
//     }
// }
// duplicateChildren();

// const scrollWidth = parent.scrollWidth / 2;

// parent.scrollLeft = scrollWidth; // Start from middle

// parent.addEventListener('scroll', () => {
//     if (parent.scrollLeft <= 0) {
//         parent.scrollLeft = scrollWidth;
//     } else if (parent.scrollLeft >= parent.scrollWidth - parent.clientWidth) {
//         parent.scrollLeft = scrollWidth - parent.clientWidth;
//     }
// });
